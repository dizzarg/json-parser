...
public final class ReflectionUtil {
    ...
    public static <T> void fillField(Object[] values, T t, Field field) throws NoSuchFieldException, IllegalAccessException {
        field.setAccessible(true);
        List list = Arrays.asList(values);
        final Object refArray = Array.newInstance(field.getType().getComponentType(), list.size());
        final Object aggregatedList = list.toArray((Object[]) refArray);
        field.set(t, aggregatedList);
    }
    ...
    public static boolean isIterable(Object obj) {
        return obj.getClass().isArray() || (obj instanceof Class<?> && ((Class<?>)obj).isArray()) || obj instanceof Iterable || obj instanceof Enumeration;
    }
